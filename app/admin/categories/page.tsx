  ...
  return (
    <AdminShell>
      <div className="space-y-6">
        <AdminPageHeader
          title="التصنيفات"
          description="إدارة تصنيفات الواجهة وترتيب ظهورها في الشريط الأفقي. الربط الحقيقي مع Supabase يأتي في Task 8."
        >
          <Button type="button">
        ...
        <div className="grid gap-4 xl:grid-cols-[1fr_420px]">
          ...
          <AdminFormSection title="نموذج التصنيف" description="نموذج بصري مؤقت قبل ربط React Hook Form و Zod." icon={FolderPlus}>
